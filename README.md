...
<strong>Secondly</strong> I was going to make the 'canvas' element responsive to the window size using rezise windowAPI, but I was unable to complete this feature.
